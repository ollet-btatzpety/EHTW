  ...
  (function (e) {
    ...
    function nn(e) {
      ...
      if (e.isTrusted) {
        ...
        if (Ce.y == 21 && Ce.x < 21 && Ce.x > -9 && W == "textwall") {
          window.open("https://richardwall.glitch.me"),
            Je()
        }
      ...
      if (e["isTrusted"]) {
        ...
        gn(),
          Xe + 300 > performance["now"]()
            ? (r["value"] = "")
            : client.chat.send(r["value"]["substr"](0, 1024)),
          (Xe = performance["now"]()),
          (r.value = ""),
          r.focus();
      }
    ...
    */
    ...
    function Lr(e) {
      ...
      return {
        x: Math["floor"]((Math["floor"](2e6 * r()) - 1e6)),
        y: Math["floor"]((Math["floor"](2e6 * r()) - 1e6)),
      };
    }
